...
Function to convert \hyperlink{classCamera}{Camera} coordinates to image coordinates. 
...
Function to convert image coordinates to \hyperlink{classCamera}{Camera} coordinates. 
